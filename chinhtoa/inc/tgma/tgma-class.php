					...
					public function add_strings() {
						if ( 'update' === $this->options['install_type'] ) {
							...
							if ( $this->tgmpa->is_automatic ) {
								...
								/* translators: 1: plugin name. */
								// Patched for WP 6.3+/7.0: core's Bulk_Upgrader_Skin::after() now calls
								// sprintf($string, $title) with a single arg and renders its own "More
								// details." toggle, so the old %2$s onclick anchor caused an
								// ArgumentCountError. Keep a single-placeholder string.
								...
								/* translators: 1: plugin name. */
								// Patched for WP 6.3+/7.0 (see note above): single-placeholder string only.
